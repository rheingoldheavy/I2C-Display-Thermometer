...
const int  AT30TS750_I2C           = 0x48;  // Temperature Sensor IC I2C Address
const int  REGISTER_TEMP           = 0x00;  // Register Address: temperature data
const int  REG_CONFIG              = 0x01;  // Register Address: Sensor Configuration
